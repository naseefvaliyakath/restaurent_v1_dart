...
import '../controller/online_booking_billing_controller.dart';


class OnlineBookingBillingBinding implements Bindings {
  @override
  void dependencies() {
    Get.put<FoodsRepo>(FoodsRepo());
    Get.put<OnlineBookingBillingController>(OnlineBookingBillingController());
