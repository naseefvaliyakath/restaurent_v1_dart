                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      10.horizontalSpace,
                      WhiteButtonWithIcon(text: 'Enter Address',icon: Icons.edit,onTap: ()=>deliveryAddressAlert(context),)
                    ],
                  ),
                  Container(
                    decoration: BoxDecoration(
                  ...
                  Container(
                      ...
                      child:Row(
                        ...
                        children: [
                          BigText(text: 'Totel : ',size: 18.sp,),
                          20.horizontalSpace,
                          BigText(text: 'Rs 235',size: 18.sp,color: Colors.black54,)
                        ],)
                  ),
                  // controlle buttons
                  Container(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: AppMIniButton(
                                ...
                                text: 'Deliver',
                                onTap: () {
                                  deliveryboySelectAlert(context);
                                },
                              ),
                            ),
                            3.horizontalSpace,
