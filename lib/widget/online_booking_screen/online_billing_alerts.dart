...
class OnlineBookingBillingAlert{
  static foodBillingAlert(
    ...
    await Get.find<OnlineBookingBillingController>().updatePriceFirstTime(price);

    // set quantity zero
    await Get.find<OnlineBookingBillingController>().setQntToZero();
  ...
  static deleteItemFromBillAlert(context, index) async {
    ...
    ktNoteController.text = Get.find<OnlineBookingBillingController>().billingItems[index]['ktNote'];
    //set edit options hide first time
    await Get.find<OnlineBookingBillingController>().setIsVisibleEditBillItemFales();
    //update price from list of bills
    await Get.find<OnlineBookingBillingController>().updatePriceFirstTime(Get.find<OnlineBookingBillingController>().billingItems[index]['price']);
    //update qnt from list of bills
    await Get.find<OnlineBookingBillingController>().updateQntFirstTime((Get.find<OnlineBookingBillingController>().billingItems[index]['qnt']));
    ...
    AwesomeDialog(
      ...
      showCloseIcon: true,
      btnCancel: GetBuilder<OnlineBookingBillingController>(builder: (ctrl) {
        return DialogButton(
          icon: Icons.delete,
          onPressd: () async {
            Navigator.pop(context);
      ...
      btnOk: GetBuilder<OnlineBookingBillingController>(builder: (ctrl) {
        return DialogButton(
