...
class ListTileCircleTableChairWidget extends StatelessWidget {
  ...
  const ListTileCircleTableChairWidget(
      {Key? key,
                  ...
                  children: [
                        ...
                        child: Column(
                          ...
                          children: List<Widget>.generate(leftChairCount, (index) {
                            ...
                            return ChairWidgetWithOnTap(
                              ...
                              text: 'C ${index + 1}',
                              onTap: () async {
                                await onChairTap('L', index,kotId);
                              },
                            );
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Column(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: List<Widget>.generate(rightChairCount, (index) {                            bool isChairHasOrder = false;
                            int kotId = -1;
                            List<KotTableChairSet> kotTbSet = ctrl.kotTableChairSetList;
                            for (var element in kotTbSet) {
                              //check this tale is in kotTable list
